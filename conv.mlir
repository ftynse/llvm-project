...
^bb0(%arg0: !transform.any_op):
  ...
  transform.structured.fuse_into_containing_op %bias into %co_loop
  ...
  // %convs = transform.structured.match ops{["linalg.conv_2d_nhwc_fhwc"]} in %arg0 : (!transform.any_op) -> !pdl.operation
